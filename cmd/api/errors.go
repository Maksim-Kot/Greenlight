...
// The failedValidationResponse() method will be used to send 422 Unprocessable Entity and the
...
// The authenticationRequiredResponse() method will be used to send a 401 Unauthorized response
// status code and JSON response to the client.
...
// The inactiveAccountResponse() method will be used to send a 403 Forbidden response
// status code and JSON response to the client.
...
// The notPermittedResponse() method will be used to send a 403 Forbidden response
// status code and JSON response to the client.
